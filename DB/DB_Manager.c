...
void DBM_initDB()
{
	...
	DBM_AddToCourse(3, First.PersonalInfo_Form.id);

	DBM_AddToCourse(2, Second.PersonalInfo_Form.id);
	DBM_AddToCourse(1, Second.PersonalInfo_Form.id);

	DBM_AddToCourse(5, Third.PersonalInfo_Form.id);
	DBM_AddToCourse(6, Third.PersonalInfo_Form.id);
}
